This is a generative art project which turns images into "force-field" particle animations in real-time. The project is open source (MIT license), so feel free to use it for whatever you wish.
